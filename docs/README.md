...
# 2. 【前置知识】网络通讯模型核心
## 2.1 BIO技术(阻塞IO)
BIO demo：[BIO](../src/main/java/com/cherry/cherryrpc/predemo/demo1_BioAndNio/BioServer.java)
...
### 改进方案二：
在JDK的NIO模型中就有相关的设计【[简单NIO服务器](../src/main/java/com/cherry/cherryrpc/predemo/demo1_BioAndNio/NioSocketServer.java)】
![img_8.png](img_8.png)
